...
data_loader = data_importer.data_importer('..\\Processed_Data\\user_baskets',load_batch = 100,train_batch = 5)
...
def val_error():
	...
	while(not val_data_loader.end_of_file):
		...
		if(in_sample.size > 0):
			...
			data_positives 	+= sess.run(tf.reduce_sum(ordered_items),feed_dict = {input_data:in_sample})
	print("Correct: {}, False Positives: {}, False Negatives: {}, Data Positives: {}".format(correct,false_positives,false_negatives,data_positives))
	# print(n)
